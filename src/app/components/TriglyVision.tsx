...
interface Props {
  datos: TrigliceridosData[];
}

const TriglyVision: React.FC<Props> = ({ datos }) => {
  return (
    <div className="bg-white p-4 shadow-md rounded-lg overflow-x-auto min-w-full flex-grow">
      <h2 className="text-blue-500 text-2xl font-semibold mb-4">TriglyVision</h2>
